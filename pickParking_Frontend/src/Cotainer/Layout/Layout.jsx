...
const SideBar = () => {
  ...
  return (
    ...
    <Layout>
      <Header className="sticky top-0 z-50 bg-[#101111] px-2 shadow-md">
      ...
      >
        ...
        />
          ...
          <div className="flex items-center gap-4">
            ...
            <Space>
          <Button
          icon={ <div className="w-8 h-8 -bggradient-to-br from-pink-500 to-rose-600 rounded-lg flex items-center justify-center">
            <User className="h-4 w-4 text-white" />
          </div>}
          className="hidden md:flex items-center space-x-3 bg-gray-200/50 rounded-xl px-3 py-1 border border-gray-600/50"
            onClick={() => {
              navigate("/login");
            }}
          >
